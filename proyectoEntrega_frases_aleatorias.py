...
# Listas de frases para cada animal del horóscopo chino
frases_Rata = [
    "Eres ingenioso y adaptable, siempre encuentras soluciones rápidas a los problemas. Tu inteligencia te ayuda a ver oportunidades donde otros no ven nada.",
    "Tienes una gran habilidad para hacer amigos, y tu naturaleza encantadora hace que los demás disfruten de tu compañía.",
    "Tu ambición te lleva a trabajar duro, pero recuerda que también es importante relajarse y disfrutar el momento."
]

frases_Buey = [
    "Eres persistente y confiable, una persona en la que todos pueden confiar para mantener la estabilidad.",
...
frases_Tigre = [
    "Tu valentía y espíritu independiente te convierten en un líder nato. No temes tomar riesgos para lograr lo que deseas.",
...
frases_Conejo = [
    "Eres amable y empático, una persona que siempre busca ayudar a los demás y crear un ambiente de paz.",
...
frases_Dragon = [
    "Tienes una presencia magnética y poderosa, y tu confianza en ti mismo inspira a quienes te rodean.",
...
frases_Serpiente = [
    "Eres sabio y observador, una persona que siempre ve más allá de la superficie y analiza cada situación.",
...
frases_Caballo = [
    "Eres libre y aventurero, siempre buscando nuevas experiencias y disfrutando de la vida al máximo.",
...
frases_Cabra = [
    "Eres amable y considerado, siempre buscando armonía en tus relaciones y queriendo ayudar a quienes te rodean.",
...
frases_Mono = [
    "Eres ingenioso y divertido, siempre encuentras una manera de alegrar el ambiente con tu sentido del humor.",
...
frases_Gallo = [
    "Eres organizado y detallista, siempre tienes un plan para todo y te aseguras de que todo esté en orden.",
...
frases_Perro = [
    "Eres leal y honesto, una persona en la que todos confían y acuden en busca de apoyo.",
...
frases_Cerdo = [
    "Eres generoso y bondadoso, siempre dispuesto a ayudar y a dar lo mejor de ti.",
